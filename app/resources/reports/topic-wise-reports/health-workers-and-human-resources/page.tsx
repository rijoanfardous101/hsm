...
const pdfs = [
  {
    ...
    filePath:
      "/resources/TopicWiseReports/Health-workers-and-human-resources/Assessment of-Healthcare Providers in Banglades 2021_WHO.pdf",
  },
  {
    title: "Bangladesh Health Workforce Strategy 2023_MOHFW",
    filePath:
      "/resources/TopicWiseReports/Health-workers-and-human-resources/Bangladesh Health Workforce Strategy 2023_MOHFW.pdf",
  },
  {
    title: "Global Strategy on Human Resources for Health_WHO 2018",
    filePath:
      "/resources/TopicWiseReports/Health-workers-and-human-resources/Global Strategy on Human Resources for Health_WHO 2018.pdf",
  },
  {
    title: "Health Worker Mobility and Migration 2024_WHO",
    filePath:
      "/resources/TopicWiseReports/Health-workers-and-human-resources/Health Worker Mobility and Migration 2024_WHO.pdf",
  },
  {
    title: "Health Workforce 2030_WHO",
    filePath:
      "/resources/TopicWiseReports/Health-workers-and-human-resources/Health Workforce 2030_WHO.pdf",
  },
  {
    title: "Policy on Health Workforce_PAHO 2023",
    filePath:
      "/resources/TopicWiseReports/Health-workers-and-human-resources/Policy on Health Workforce_PAHO 2023.pdf",
  },
];
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#2D8CBB]/90 to-[#2D8CBB]/40 flex items-center">
          <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-center items-center w-full px-6 md:px-16 gap-4">
            <h1 className="text-4xl md:text-5xl font-extrabold text-white">
              Health Workers and Human Resources
            </h1>
          </div>
        </div>
      </div>
