            ...
            <div className="md:col-span-2 flex flex-col gap-8">
              ...
              <div className="w-full text-gray-700 text-justify">
                <p className="text-base leading-7">
                  This platform offers information on job openings and
                  fellowship opportunities from various organizations. Regularly
                  checking these sites can help you advance your career and
                  discover rewarding opportunities.
                </p>
              </div>
            </div>
