        ...
        <div className="max-w-screen-xl mx-auto px-6 md:px-16 py-12">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-lg md:text-xl text-gray-700 mt-4">
                    Stay updated with major global health developments shaping
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-red-600">
                    ...
                    <p className="text-gray-600">
                        The United States has officially withdrawn from the
                        World Health Organization (WHO), a move that
                        significantly impacts global health collaborations.
                    </p>
                    <a
                ...
                <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-blue-600">
                    ...
                    <p className="text-gray-600">
                        The World Health Organization (WHO) has launched its
                        Health Emergency Appeal for 2025 to address urgent
