...
const UpcomingEvent = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-6 md:px-16 py-10 pb-16">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-[#F18A00]">
          <h2 className="text-xl font-bold text-gray-800 mb-3">📺 Webinars</h2>
          <ul className="space-y-2">
            <li>
              <a
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 border-l-4 border-[#34A853]">
          <h2 className="text-xl font-bold text-gray-800 mb-3">🎟️ Events</h2>
          <ul className="space-y-2">
            <li>
              <a
