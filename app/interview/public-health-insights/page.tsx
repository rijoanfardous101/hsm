      ...
      <div className="max-w-screen-md mx-auto px-8 py-8 bg-white ">
        ...
        <div className="mb-4">
          <h2 className="text-[18px] font-bold text-[#2D8CBB] text-justify">
            Q. What drives your passion for public health, and what keeps you
            motivated daily?
          </h2>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
            <span className="font-bold">Madhukar Pai:</span> As a child, I
            wanted to be a doctor. But once I started medical school, I realized
            I wanted to prevent people from falling sick ("turn off the tap")
            and not fix things once people fell sick ("mop the floor"). This
            realization made me become an epidemiologist and public health
            researcher. I care about the science of disease prevention, the
            science that keeps populations healthy.
          </p>
        </div>
        ...
        <div className="mb-4">
          <h2 className="text-[18px] font-bold text-[#2D8CBB] text-justify">
            Q. Who has been your source of inspiration in your public health
            career?
          </h2>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
            <span className="font-bold">Madhukar Pai:</span> Several people
            inspired and mentored me in my career! I thanked them all in this
            TEDx talk:{" "}
            <a
        ...
        <div className="mb-4">
          <h2 className="text-[18px] font-bold text-[#2D8CBB] text-justify">
            Q. What do you consider your greatest accomplishment as a faculty
            member at a globally renowned public health institution?
          </h2>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
            <span className="font-bold">Madhukar Pai:</span> My biggest source
            of happiness and impact comes from teaching and students. I am
            passionate about teaching and mentorship. Many of my trainees are
            doing great work all over the world and seeing their success and
            impact makes me proud.
          </p>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
        ...
        <div className="mb-4">
          <h2 className="text-[18px] font-bold text-[#2D8CBB] text-justify">
            Q. What is the most pressing global public health challenge, and how
            would we address it with limited resources?
          </h2>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
            <span className="font-bold">Madhukar Pai:</span> In a world
            increasingly threatened by climate crisis, conflicts, pandemics, and
            widening economic inequities, we are not dealing with one pressing
            issue. We are dealing with polycrisis.
          </p>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
        ...
        <div className="mb-4">
          <h2 className="text-[18px] font-bold text-[#2D8CBB] text-justify">
            Q. What are the top three skills essential for success in public
            health?
          </h2>
        ...
        <div className="mb-4">
          <h2 className="text-[18px] font-bold text-[#2D8CBB] text-justify">
            Q. How has your perspective on public health evolved over the years,
            and what message would you offer to someone beginning their journey
            in this field?
          </h2>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
            <span className="font-bold">Madhukar Pai:</span> Over the years, I
            have grown to realize that the field of global health is neither
            diverse nor truly global. Every aspect of global health is dominated
            by individuals and institutions in the Global North. Global South
            scientists struggle to even get visas to attend international
            conferences. They struggle to pay article processing charges, and
            they are rarely invited to serve on editorial boards. Their
            knowledge is mostly invisible.
          </p>
          <p className="text-gray-700 mt-2 leading-relaxed text-justify text-[15px]">
