...
export default function GiftForm({ image }: GiftFormProps) {
  ...
  return (
    <div className="grid gap-8 md:grid-cols-2 items-center bg-[#cdc8ba]/30 p-8">
      <Card className="">
          ...
          {isSuccess ? (
            <div className="flex flex-col items-center justify-center py-8 text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Your gift box request has been submitted successfully. Please
                check your email for the gift box.
              </p>
            ...
            <Form {...form}>
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full text-lg bg-orange-400 hover:bg-orange-600"
